...
<%!
     ...
     public void delete(String old,String news){
        ...
        File fileToBeModified_1 = new File("C:\\Users\\User\\Documents\\NetBeansProjects\\dataAlgorithms\\web\\directory.txt");
        String details = ""; 
      ...
      try
        ...
        finally
        {
            ...
            File fileToBeModified = new File("C:\\Users\\User\\Documents\\NetBeansProjects\\dataAlgorithms\\web\\directory.txt");
            String oldContent = "";
        try
        {
  ...
  /* public void update(String old,String news){
        ...
        BufferedReader reader = null;
        try {
            fis = new FileInputStream("C:\\Users\\User\\Documents\\NetBeansProjects\\dataAlgorithms\\web\\directory.txt");
    ...
    public void print_all(){
        ...
        try {
          ...
          public void add_user(String username){
                       try {   
                            File file = new File("C:\\Users\\User\\Documents\\NetBeansProjects\\dataAlgorithms\\web\\directory.txt");
   ...
   if (request.getParameter("printUsers") != null){
       FileInputStream fis = null;
        ...
        try {
            ...
            reader = new BufferedReader(new InputStreamReader(fis));
            String line = reader.readLine();
            out.println("Data Algorithms System User List"+"<br>");
            out.println("************************************************"+"<br>");
            while(line != null){
                line = reader.readLine();
                if(line!=null){
